  ...
  },  // ← TAMBAH KOMA INI (tutup filterSidebarMenu)
  ...
  }  // ← TAMBAH KOMA KALAU MAU TAMBAH METHOD LAIN, ATAU BIARKAN KALAU INI TERAKHIR
};  // ← TUTUP OBJEK AUTH (titik koma)

// ==========================================
// ⭐ GLOBAL DROPDOWN PROTECTION (LUAR AUTH)
// ==========================================
      ...
      if (user) {
        setTimeout(() => {
          ...
          if (currentUser && currentUser.role !== 'owner') {
            ...
            protectSidebar();  // ← PANGGIL DI SINI
          }
        }, 300);
      }
    });
